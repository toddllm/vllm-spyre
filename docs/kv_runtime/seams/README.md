...
The next tranche should cover:

- attention backend and slot-mapping consumption
- next-stack platform/runtime direction

Those are intentionally not part of the first migration so the canonical docs
stay curated rather than exhaustive.
